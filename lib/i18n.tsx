...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "blog.not_configured": "Blog is not configured yet (Supabase env vars missing).",
    ...
    "admin.login_hint": "Sign in with your Supabase account to manage articles.",
    "admin.email": "Email",
    "admin.password": "Password",
    "admin.sign_in": "Sign in",
    "admin.sign_out": "Sign out",
    "admin.new_post": "New article",
    "admin.edit_post": "Edit article",
    "admin.slug": "Slug (URL)",
    ...
    "admin.save": "Save",
    "admin.delete": "Delete",
    "admin.confirm_delete": "Delete this article? This cannot be undone.",
    "admin.saving": "Saving…",
    "admin.loading": "Loading…",
    "admin.no_posts": "No articles yet. Create your first one!",
  ...
  fa: {
    ...
    "blog.label": "نوشته‌ها",
    "blog.title": "آخرین",
    "blog.title.highlight": "مقالات",
    "blog.read_more": "ادامه مطلب",
    "blog.view_all": "مشاهده همه مقالات",
    "blog.empty": "هنوز مقاله‌ای منتشر نشده — به‌زودی برگردید!",
    "blog.not_configured": "بخش مقالات هنوز پیکربندی نشده (متغیرهای محیطی Supabase تنظیم نشده‌اند).",
    "blog.not_found": "مقاله پیدا نشد",
    ...
    "admin.login_hint": "برای مدیریت مقالات با حساب Supabase خود وارد شوید.",
    "admin.email": "ایمیل",
    "admin.password": "رمز عبور",
    "admin.sign_in": "ورود",
    "admin.sign_out": "خروج",
    "admin.new_post": "مقاله جدید",
    "admin.edit_post": "ویرایش مقاله",
    "admin.slug": "نامک (آدرس)",
    "admin.cover_image": "آدرس تصویر کاور",
    "admin.tags": "برچسب‌ها (با کاما جدا کنید)",
    "admin.published": "منتشر شده",
    "admin.language": "زبان",
    "admin.add_translation": "افزودن ترجمه",
    "admin.title_field": "عنوان",
    "admin.excerpt": "خلاصه",
    "admin.content": "محتوا (مارک‌داون)",
    "admin.save": "ذخیره",
    "admin.delete": "حذف",
    "admin.confirm_delete": "این مقاله حذف شود؟ این عمل قابل بازگشت نیست.",
    "admin.saving": "در حال ذخیره…",
    "admin.loading": "در حال بارگذاری…",
    "admin.no_posts": "هنوز مقاله‌ای نیست. اولین مقاله را بسازید!",
    "admin.error_generic": "مشکلی پیش آمد.",
    "admin.back_to_site": "بازگشت به سایت",
  ...
  ar: {
    ...
    "blog.label": "مقالاتي",
    "blog.title": "أحدث",
    "blog.title.highlight": "المقالات",
    "blog.read_more": "اقرأ المزيد",
    "blog.view_all": "عرض جميع المقالات",
    "blog.empty": "لا توجد مقالات منشورة بعد — عد قريباً!",
    "blog.not_configured": "لم يتم إعداد المدونة بعد (متغيرات بيئة Supabase غير موجودة).",
    ...
    "admin.new_post": "مقال جديد",
    "admin.edit_post": "تحرير المقال",
    "admin.slug": "المعرّف (الرابط)",
    "admin.cover_image": "رابط صورة الغلاف",
    "admin.tags": "الوسوم (مفصولة بفاصلة)",
    "admin.published": "منشور",
    "admin.language": "اللغة",
    "admin.add_translation": "إضافة ترجمة",
    "admin.title_field": "العنوان",
    "admin.excerpt": "المقتطف",
    "admin.content": "المحتوى (ماركداون)",
    "admin.save": "حفظ",
    "admin.delete": "حذف",
    "admin.confirm_delete": "حذف هذا المقال؟ لا يمكن التراجع عن ذلك.",
    "admin.saving": "جارٍ الحفظ…",
    "admin.loading": "جارٍ التحميل…",
    "admin.no_posts": "لا توجد مقالات بعد. أنشئ أول مقال!",
    "admin.error_generic": "حدث خطأ ما.",
  ...
  tr: {
    ...
    "blog.label": "Yazılar",
    "blog.title": "Son",
    "blog.title.highlight": "Yazılar",
    "blog.read_more": "Devamını oku",
    "blog.view_all": "Tüm yazılar",
    "blog.empty": "Henüz yazı yayınlanmadı — yakında tekrar kontrol edin!",
    "blog.not_configured": "Blog henüz yapılandırılmadı (Supabase ortam değişkenleri eksik).",
    ...
    "admin.login_hint": "Makaleleri yönetmek için Supabase hesabınızla giriş yapın.",
    "admin.email": "E-posta",
    "admin.password": "Şifre",
    "admin.sign_in": "Giriş yap",
    "admin.sign_out": "Çıkış",
    "admin.new_post": "Yeni yazı",
    "admin.edit_post": "Yazıyı düzenle",
    "admin.slug": "URL kısaltması",
    "admin.cover_image": "Kapak görseli URL",
    "admin.tags": "Etiketler (virgülle ayırın)",
    "admin.published": "Yayında",
    "admin.language": "Dil",
    "admin.add_translation": "Çeviri ekle",
    "admin.title_field": "Başlık",
    "admin.excerpt": "Özet",
    "admin.content": "İçerik (Markdown)",
    "admin.save": "Kaydet",
    "admin.delete": "Sil",
    "admin.confirm_delete": "Bu yazı silinsin mi? Bu işlem geri alınamaz.",
    "admin.saving": "Kaydediliyor…",
    "admin.loading": "Yükleniyor…",
    "admin.no_posts": "Henüz yazı yok. İlk yazınızı oluşturun!",
    "admin.error_generic": "Bir şeyler ters gitti.",
