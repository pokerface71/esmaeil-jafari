...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section
        ref={refs.home}
        className="pt-24 pb-20 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 text-white"
      >
      ...
      {/* About Section */}
      <section ref={refs.about} className="py-20 bg-white">
        <div className="container mx-auto px-4">
      ...
      {/* Skills Section */}
      <section ref={refs.skills} className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
            Skills
          </h2>
      ...
      {/* Experience Section */}
      <section ref={refs.experience} className="py-20 bg-white">
        <div className="container mx-auto px-4">
            ...
            <div className="relative pl-8 pb-12 border-l-4 border-blue-500 animate-slide-in-left">
              ...
              <div className="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-gray-700 leading-relaxed animate-fade-in">
                  ...
                  industry with multiple applications. As a Frontend Developer,
                  my primary responsibility is to modernize and refactor the
                  legacy application from the ground up. This involves
                  implementing modern technologies, improving application
                  performance, and ensuring a seamless user experience across
                  all platforms. I have contributed to the development of
                  several key platforms including:
                </p>
                ...
                <p className="text-sm text-gray-600 mt-4 animate-fade-in">
                  ...
                  Text-to-Speech | SignalR | JavaScript | Micro Frontend | Redux
            ...
            <div className="relative pl-8 pb-12 border-l-4 border-blue-500 animate-slide-in-left">
              ...
              <div className="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-gray-700 leading-relaxed animate-fade-in">
                  ...
                  responsible for refactoring, developing, and maintaining both
                  the public website and the admin panel. My work focused on
                  creating responsive and user-friendly interfaces that enhanced
                  the overall user experience and encouraged book purchases.
                </p>
                <p className="text-sm text-gray-600 mt-4 animate-fade-in">
      ...
      {/* Contact Section */}
      <section ref={refs.contact} className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
            Contact Me
          </h2>
